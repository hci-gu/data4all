...
export default function Page({ params: { slug } }: { params: { slug: string } }) {
    const user = { id: 1, name: 'Sebastian Andreasson', roll: 'Business Intelligence', initials: 'SA' }
    const TagsData = [
        {
            id: 1,
            href: "/tag/Geodata",
    ...
    const DatasetsData = [
        {
            title: "Lekplatser",
            description: "Datamängden lekplatser omfattar barnvänliga områden där barn kan leka säkert.",
            href: "/dataset/Lekplatser"
        },
        {
            title: "Badplatser",
            description: "Datamängden badplatser innehåller information om offentliga sjöar, floder eller pooler där invånare kan bada.",
    ...
    return (
        <main className="grid grid-cols-[1fr_auto_1fr] gap-9 items-stretch px-28 py-9">
            <div className="flex flex-col gap-4">
                ...
                <section aria-labelledby="RelatedDatasets" className="flex flex-col gap-2">
                    <h2 id="RelatedDatasets" className="text-2xl font-bold">Relaterade dataset</h2>
